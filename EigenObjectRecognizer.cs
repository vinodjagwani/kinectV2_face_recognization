...
namespace Emgu.CV
{
    ...
    /// </summary>
    [Serializable]
    public class EigenObjRecognizer
    {
        ...
        public EigenObjRecognizer(Image<Gray, Byte>[] images, ref MCvTermCriteria termCrit)
        ...
        /// <param name="termCrit">The criteria for recognizer training</param>
        public EigenObjRecognizer(Image<Gray, Byte>[] images, String[] labels, ref MCvTermCriteria termCrit)
        ...
        /// </param>
        /// <param name="termCrit">The criteria for recognizer training</param>
        public EigenObjRecognizer(Image<Gray, Byte>[] images, String[] labels, double eigenDistanceThreshold, ref MCvTermCriteria termCrit)
        {
